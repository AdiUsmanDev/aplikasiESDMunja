...
<head>
  ...
  <title>Profile Kepala Dinas</title>
  <!--     Fonts and icons     -->
  ...
  <nav class="relative flex flex-wrap items-center justify-between px-0 py-2 mx-6 transition-all ease-in shadow-none duration-250 rounded-2xl lg:flex-nowrap lg:justify-start" navbar-main navbar-scroll="false">
    <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
      <nav>
        ...
        <h6 class="mb-0 font-bold text-white capitalize">Profil Kepala Dinas</h6>
      </nav>
              ...
              <div class="flex flex-wrap -mx-3">
                ...
                <div class="flex items-center justify-end space-x-6 p-4 bg-transparent">
                  ...
                  <div class="flex flex-col justify-center">
                    <h1 class="text-base text-m font-bold dark:text-white">Nama</h1>
                    <p class="text-m font-semibold leading-normal dark:text-white dark:opacity-60">NIP</p>
                  </div>
                </div>
              </div>
