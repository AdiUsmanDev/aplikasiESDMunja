...
<head>
  ...
  <title>Profile Tim Teknis</title>
  <!--     Fonts and icons     -->
    ...
    <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
      <nav>
        ...
        <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
          ...
          <li class="text-sm pl-2 capitalize leading-normal text-white before:float-left before:pr-2 before:text-white before:content-['/']" aria-current="page">Profil Tim Teknis</li>
        </ol>
        <h6 class="mb-0 font-bold text-white capitalize">Profil Tim Teknis</h6>
      </nav>
              ...
              <div class="flex flex-wrap -mx-3">
                ...
                <div class="flex items-center justify-end space-x-6 p-4 bg-transparent">
                  ...
                  <div class="relative w-32 h-32">
                    ...
                    <input type="file" id="uploadFoto" accept="image/*" class="hidden" onchange="previewGambar(event)">
                  ...
                  <div class="flex flex-col justify-center">
                    ...
                    <p class="text-sm font-semibold leading-normal dark:text-white dark:opacity-60">NIP</p>
                  </div>
                </div>
              </div>
                ...
                <div class="mb-6">
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <select name="pangkat_golongan" id="pangkat_golongan" data-required
                        class="w-full px-3 py-2 text-sm text-gray-700 bg-white border border-gray-300 rounded-lg placeholder:text-gray-500 focus:outline-none focus:border-blue-500 dark:bg-slate-850 dark:text-white">
