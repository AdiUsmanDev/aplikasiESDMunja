      ...
      <tbody id="body-nonSurya">
        ...
        <tr>
                              ...
                              <tr>
                                <td>Foto Papan Nama (Name Plate) Generator</td>
                                <td>
                                  <input type="file" name="foto_generator_1" accept="application/pdf, image/jpeg, image/png/*" onchange="previewGambar(this, 'preview_generator_1')"data-required>
                                  <img id="preview_generator_1" class="mt-2 w-24 hidden border rounded" />
                                </td>
                              </tr>
                              <tr>
                                <td>Foto Papan Nama (Name Plate) Mesin Penggerak</td>
                                <td>
                                  <input type="file" name="foto_mesin_1" accept="application/pdf, image/jpeg, image/png/*" onchange="previewGambar(this, 'preview_mesin_1')"data-required>
                                  <img id="preview_mesin_1" class="mt-2 w-24 hidden border rounded" />
                                </td>
                              </tr>
