...
<head>
  ...
  <title>Beranda Tim Teknis</title>
  <!--     Fonts and icons     -->
          ...
          <div class="border-black/12.5 dark:bg-slate-850 dark:shadow-dark-xl shadow-xl relative z-20 flex min-w-0 flex-col break-words rounded-2xl border-0 border-solid bg-white bg-clip-border">
            ...
            <div class="w-full px-4 py-3">
              <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 text-center text-sm font-medium text-gray-600">
                ...
                <div class="cursor-pointer" onclick="showStep(1)">
                  ...
                  <div class="text-m text-blue-500 font-semibold mt-1">Permohonan</div>
                </div>
                ...
                <div class="cursor-pointer" onclick="showStep(4)">
                  ...
                  <div class="text-m text-blue-500  font-semibold mt-1">Surat Keterangan</div>
                </div>
              </div>
            ...
            <script>
              function showStep(step) {
                ...
                switch (step) {
                  case 1:
                    content.innerHTML = `<strong>Permohonan:</strong> Surat permohonan telah diajukan oleh pemohon. Menunggu evaluasi.`;
                    break;
                  case 2:
                  ...
                  case 3:
                    ...
                    break;
                  case 4:
                    content.innerHTML = `<strong>Surat Keterangan:</strong> Surat keterangan telah diterbitkan dan siap diunduh.`;
                    break;
                  default:
      ...
      <div class="flex flex-wrap mt-6 -mx-3">
        ...
        <div class="w-full max-w-full px-3 mb-6 "> <!--lg:w-6/12-->
          <div class="flex flex-col h-full bg-white dark:bg-slate-850 shadow-xl dark:shadow-dark-xl rounded-2xl p-6 overflow-x-auto">
            ...
            <thead class="bg-blue-500 dark:bg-slate-700 text-white dark:text-white/90">
                <tr>
              ...
              <tbody class="text-gray-700 dark:text-white/80">
                <tr class="hover:bg-gray-50 dark:hover:bg-slate-700">
                  <td class="px-4 py-2 text-m border-b font-semibold dark:border-gray-600">0001</td>
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-slate-700">
                  <td class="px-4 py-2 text-m border-b font-semibold dark:border-gray-600">0002</td>
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-slate-700">
                  <td class="px-4 py-2 text-m border-b font-semibold dark:border-gray-600">0003</td>
                  <td class="px-4 py-2 text-m border-b dark:border-gray-600">CV Sinar Abadi</td>
                  <td class="px-4 py-2 text-m border-b dark:border-gray-600">Hidayatullah</td>
                </tr>
              </tbody>
            </table>
          </div>
